...
class DownloadOnePagePeople(threading.Thread):
    ...
    def run(self):
        ...
        queryUrl = 'http://www.bf99.com/User/List_search____2______%s.htm' % pageNum
        ...
        #for personUrl in personUrlList:
            ...
            for k in range(len(picsUrlList)):
                ...
                #picFilePath = os.path.join('%s_%s_m' % (personId, age), 'picsUrlList')
                filehandler = open(os.path.join('%s_%s_m' % (personId, age), 'picsUrlList.txt'), 'a')
